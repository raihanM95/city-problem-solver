...
namespace CityProblemSolver.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(CityProblemSolverDBContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Phone,NID,Address,UserName,Password,UserType")] User user)
        {
            if (id != user.ID)
            {
                return NotFound();
